(function(){
    ...
    var second_nav = document.createElement('div');
    second_nav.style.backgroundColor = "gray";
    second_nav.innerText= "Curse of the current reviews";
    document.body.appendChild(second_nav);


    var third_nav= document.createElement('div');
    third
